...
class AppDimensions {
  ...
  // Border Radii
  static final BorderRadius cardBorderRadiusSmall =
  BorderRadius.circular(cardRadiusSmall);
  static final BorderRadius cardBorderRadiusMedium =
  BorderRadius.circular(cardRadiusMedium);
  static final BorderRadius cardBorderRadiusLarge =
